...
@section('content')
  <main class="p-6 max-w-7xl mx-auto space-y-10">
    ...
    <h2 class="text-xl font-semibold text-yellow-600 dark:text-yellow-400 mb-1">Selamat Datang, {{ Auth::user()->name }}
    </h2>
    <p class="text-gray-700 dark:text-gray-300">
      Anda login sebagai <strong>{{ Auth::user()->email }}</strong>. Dashboard ini dirancang
      untuk membantu Anda memantau sistem dengan mudah.
    </p>
    </div>
    ...
    <select id="filterWaktu"
      class="border rounded-md px-4 py-2 text-sm shadow-sm text-gray-800 bg-white dark:text-white dark:bg-gray-800 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-yellow-400 transition">
